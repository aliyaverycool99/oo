...
import icmit.oodb.lab8.annotation.ManyToOne;
import icmit.oodb.lab8.domain.Position;
...
public class EntityManagerImpl implements EntityManager {
  ...
  private final String URL = "jdbc:postgresql://localhost:5433/uchet";
  ...
  Field[] getFields(Object object) {
    ...
    if (object.getClass().getCanonicalName().equals("oodb.lab7.classes.Position")) {
      Field[] personFields = Position.class.getSuperclass().getDeclaredFields();
      Field[] authorFields = Position.class.getDeclaredFields();
