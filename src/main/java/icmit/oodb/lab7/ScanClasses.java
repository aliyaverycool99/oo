...
import icmit.oodb.lab7.classes.Position;
...
public class ScanClasses {
  ...
  public static String PATH_FOR_SCAN = "icmit.oodb.lab7.classes";
...
//      System.out.println("\tField annotations of class " + c.getName());
      if (c.getCanonicalName().equals("oodb.lab7.classes.Position")) {
...
//    System.out.println("STEP 6: get superclass:");
    ...
    Class superClass = Position.class.getSuperclass();
